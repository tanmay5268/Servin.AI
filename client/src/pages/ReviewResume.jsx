    ...
    >
      {/* Form Section */}
        ...
        >
          ...
          <input
            onChange={(e) => setInput(e.target.files[0])} type='file' accept='.pdf,.doc,.docx'
            className="w-full p-3 mt-2 outline-none text-sm rounded-md border border-gray-300 text-gray-600"
            required
          />
          
          <p className='text-xs text-gray-500 font-light mt-1'>Supports pdf, doc, docx and other image formats</p>


          <button className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#E3FF00] to-[#00FFBF] text-white px-4 py-2 mt-6 text-sm rounded-full cursor-pointer">
