...
text-slate-700"
    >
      ...
      >
        ...
        <button
          disabled={loading}
          className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#F6AB41] to-[#FF4938] text-white px-4 py-2 mt-6 text-sm rounded-full cursor-pointer"
        >
...
text-gray-400"
          >
            <Eraser className="w-full h-10 " />
            <p>Upload an image and click "Remove Background" to get started</p>
          </div>
        </div>):(<img src={content} alt="Processed" className="mt-4 rounded-md max-h-[500px] object-contain"/>)}
