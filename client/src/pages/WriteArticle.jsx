    ...
    >
      ...
      >
        ...
        <input onChange={(e) => setInput(e.target.value)} value={input}
          type="text"
          className="w-full p-2 px-3 mt-2 outline-none text-smrounded-md border border-gray-300"
          placeholder="The future of artificial Intelligence is..."
          required
        />
        <p className="mt-4 text-sm font-mendium">Article Lenght</p>
        <div className="flex mt-3 gap-3 flex-wrap sm:max-w-9/11">
