    ...
    >
      {/* Form Section */}
        ...
        >
          ...
          <button className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#417DF9] to-[#8E37EB] text-white px-4 py-2 mt-6 text-sm rounded-full cursor-pointer">
