...
text-slate-700"
    >
      ...
      >
        ...
        <button
          disabled={loading}
          className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00AD25] to-[#04FF50] text-white px-4 py-2 mt-6 text-sm rounded-full cursor-pointer"
        >
          {loading ? "Generating..." : <Image className="w-5" />}
          Generate Images
        </button>
      </form>
      {/* Result Section */}
